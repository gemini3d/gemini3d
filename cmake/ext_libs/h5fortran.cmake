...
if(hdf5)
  ...
  ExternalProject_Add(H5FORTRAN
    ...
    CMAKE_ARGS -Dhdf5_external:BOOL=${hdf5_external} -DCMAKE_INSTALL_PREFIX:PATH=${h5fortran_ROOT} -DBUILD_SHARED_LIBS:BOOL=false -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTING:BOOL=false
