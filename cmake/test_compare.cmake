...
if(python_ok AND hdf5)
  ...
  COMMAND ${Python3_EXECUTABLE} ${PROJECT_SOURCE_DIR}/scripts/gemini_compare.py ${_outdir} ${_refdir} -file_format h5)
...
if(python_ok AND netcdf)
  ...
  COMMAND ${Python3_EXECUTABLE} ${PROJECT_SOURCE_DIR}/scripts/gemini_compare.py ${_outdir} ${_refdir} -file_format nc)
