...
#gemini_ilupack: $(OBJDIR)advec_mpi.o $(OBJDIR)diffusion.o $(OBJDIR)ionization.o $(OBJDIR)phys_consts.o $(OBJDIR)potential_ilupack.o \
	$(OBJDIR)statevarICs.o $(OBJDIR)calculus.o $(OBJDIR)gemini.o $(OBJDIR)msis00_gfortran.o $(OBJDIR)potentialBCs3D.o $(OBJDIR)precipBCs.o \
	$(OBJDIR)temporal.o $(OBJDIR)collisions.o $(OBJDIR)io.o $(OBJDIR)neutral.o $(OBJDIR)potential_comm_ilupack.o $(OBJDIR)sources.o \
...
$(OBJDIR)msis00_gfortran.o: ./neutral/neutral.f90
	$(FC) -c $(OPTIM2) $(OPTIONS) ./neutral/msis00/msis00_gfortran.f -o $(OBJDIR)/msis00_gfortran.o -J$(OBJDIR)
...
#NOTE THAT ALL POTENTIAL SOLVERS WILL BE COMPILED IN ORDER FOR THESE DEPENDENCIES TO BE MET, BUT ONLY SOLVERS FOR A PARTICULAR EXECUTABLE WILL BE LINKED.  THERE HAS GOT TO BE A CLEANER WAY TO ACCOMPLISH THIS...
#$(OBJDIR)gemini.o: gemini.f90 $(OBJDIR)phys_consts.o $(OBJDIR)potential_comm_mumps.o $(OBJDIR)potential_comm_ilupack.o $(OBJDIR)temporal.o $(OBJDIR)neutral.o \
	$(OBJDIR)io.o $(OBJDIR)mpimod.o $(OBJDIR)multifluid.o $(OBJDIR)grid.o
...
#$(OBJDIR)potentialBCs3D.o: ./numerical/potential/boundary_conditions/potentialBCs3D.f90
#	$(FC) -c $(OPTIM2) ./numerical/potential/boundary_conditions/potentialBCs3D.f90  -o $(OBJDIR)/potentialBCs3D.o -J$(OBJDIR)

#$(OBJDIR)potential_ilupack.o:  ./numerical/potential/potential_ilupack.f90 $(OBJDIR)calculus.o
#	$(FC) -c $(OPTIM2) ./numerical/potential/potential_ilupack.f90 -o $(OBJDIR)/potential_ilupack.o  -O4 -fPIC -m64 -fdefault-integer-8 -fimplicit-none -mcmodel=medium -I$(ILUDIR) -I$(ILUDIR)/include -I./numerical/calculus  -D_DOUBLE_REAL_ -D_LONG_INTEGER_ -J$(OBJDIR)
