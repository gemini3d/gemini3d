...
def main(package_manager: str):
    ...
    if sys.platform == 'linux':
        ...
        pkgs = {'yum': ['epel-release', 'pkg-config', 'gcc-gfortran', 'make', 'ninja-build',
                        'MUMPS-openmpi-devel', 'lapack-devel', 'scalapack-openmpi-devel', 'openmpi-devel', 'octave'],
                'apt': ['pkg-config', 'gfortran', 'make', 'ninja-build',
                        'libmumps-dev', 'liblapack-dev', 'libscalapack-mpi-dev', 'libopenmpi-dev', 'octave']
                }
        ...
        pkgs = ['gcc-fortran', 'make', 'ninja', 'liblapack-devel', 'libopenmpi-devel', 'octave']
        ...
        raise SystemExit('It is easiest to either use Intel compilers for Windows, or use Windows Subsystem for Linux.')
    else:
