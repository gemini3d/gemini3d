...
public :: init_procgrid, outdir_fullgridvaralloc, read_grid_in, get_initial_state, &
            ...
            RK2_prep_mpi_allspec_in,get_gavg_Tinf_in, clear_dneu_in, mpisetup_in, mpiparms, RK2_global_boundary_allspec_in, &
            halo_fluidvars_in
...
contains
  ...
  !> prepare/halo data for compression substep; global boundaries
