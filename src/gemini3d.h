...
extern void check_finite_output(double*, double*, double*, double*, int*, int*, double*);
...
extern void sweep3_allparams_C(int*);
extern void sweep1_allparams_C(int*);
extern void sweep2_allparams_C(int*);
extern void rho12v1();
...
extern void init_Efieldinput(double*, double*, int*, double*);
extern void pot2perpfield_C();
extern void BGfield_Lagrangian(double*, double*);
extern void init_precipinput(double*, double*, int*, double*, double*, double*);
