...
else if (isperiodic) then   ! there is the possibility on a periodic grid with lid3=1 that we still need to enforce periodic conditions.  FIXME:  I'm not super pleased about how sloppy the logic is here; may consider cleaning up a bit.  
