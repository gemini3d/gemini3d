...
subroutine gemini_main(out_dir, lid2in, lid3in, debug)  bind(C, name="gemini_main")
...
!> Define parameters in Gemini3D's "cfg" structure/type
cfg%outdir = expanduser(out_dir)
