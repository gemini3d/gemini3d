...
!> MZ - for reasons I don't understand this creates message size errors at runtime; the solution appears to be
!    just to directly use mpi_send, etc. directly from mpi module.  
!interface
