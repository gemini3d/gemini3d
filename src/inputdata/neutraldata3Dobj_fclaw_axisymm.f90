module neutraldata3Dobj_fclaw_axisymm
...
type, extends(neutraldata3D_fclaw) :: neutraldata3D_fclaw_axisymm
...
!          self%proj_exp_e3(ix1,ix2,ix3)=tmpsca
          ...
          phip=atan2(self%yimat(ix1,ix2,ix3),self%ximat(ix1,ix2,ix3))
