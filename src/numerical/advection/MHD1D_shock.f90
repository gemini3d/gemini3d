...
rhou3=0
B1=0
B2=50e-9*exp(-(x1-1000e3)**2/(50e3)**2)
B3=0
...
!  rhou1(1:lx1)=rhou1(1:lx1)+dt*(1/mu0*B1(1:lx1)*derivative(B1(1:lx1),dx1(1:lx1)))
  ...
  !SOURCE TERMS FOR INTERNAL ENERGY (RK2 STEPPING)
