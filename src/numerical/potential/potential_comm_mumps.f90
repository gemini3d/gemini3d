...
print*, 'pot2perpfield ',myid, ' prehalo 2', x%flagper, &
          minval(J1halo(1:lx1,1:lx2,1:lx3)), &
          maxval(J1halo(1:lx1,1:lx2,1:lx3)), &          
          minval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          maxval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          J1halo(1,1,0),J1halo(1,1,lx3+1)

call halo_pot(J1halo,tag%J1,x%flagper,.true.)

print*, 'pot2perpfield ',myid, ' haloed 2', x%flagper, minval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          maxval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          J1halo(1,1,0),J1halo(1,1,lx3+1)
...
print*, 'pot2perpfield ',myid, ' haloed 3', x%flagper, minval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          maxval(J1halo(0:lx1+1,0:lx2+1,0:lx3+1)), &
          J1halo(1,1,0),J1halo(1,1,lx3+1)
...
print*, 'halopot idcheck 1:  ',myid,myid2,myid3,minval(parmhalo(1:lx1,1:lx2,1:lx3)),maxval(parmhalo(1:lx1,1:lx2,1:lx3))
print*, 'halopot idcheck 1'':  ',myid,myid2,myid3,minval(parmhalo(0:lx1+1,0:lx2+1,0:lx3+1)), &
             maxval(parmhalo(0:lx1+1,0:lx2+1,0:lx3+1))
...
print*, 'halopot idcheck 2:  ',myid,myid2,myid3,minval(parmhalo(1:lx1,1:lx2,1:lx3)),maxval(parmhalo(1:lx1,1:lx2,1:lx3))
print*, 'halopot idcheck 2'':  ',myid,myid2,myid3,minval(parmhalo(0:lx1+1,0:lx2+1,0:lx3+1)), &
             maxval(parmhalo(0:lx1+1,0:lx2+1,0:lx3+1))
