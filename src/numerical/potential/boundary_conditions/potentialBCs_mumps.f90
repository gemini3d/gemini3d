...
public :: potentialbcs2D, potentialbcs2D_fileinput, init_Efieldinput, &
            compute_rootBGEfields, potentialBCs2D_fileinput_nompi, compute_BGEfields_nompi
contains
        ...
        do ix3=1,lx3all     !here this is L-shell
          ...
          do ix1=1,lx1
            ...
            elseif ((z>=150e3_wp) .and. (z<=300e3_wp)) then
              E03all(ix1,ix2,ix3) = (veltime*vamp*(z-150e3_wp)/150e3_wp)*x%Bmagall(ix1eq,ix2,ix3)
