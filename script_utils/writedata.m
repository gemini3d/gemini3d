function writedata(ymd, UTsec,ns,vsx1,Ts, outdir, file_format)
...
switch file_format
  ...
  case {'dat','raw'}, write_raw(outdir, ymd, UTsec, ns, vsx1, Ts)
...
function write_raw(outdir, ymd, UTsec, ns, vsx1, Ts)
