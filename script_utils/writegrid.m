function writegrid(xg, outdir, format)
...
validateattributes(format, {'char'}, {'vector'}, mfilename,'raw or hdf5',3)
...
h5save(fn, '/lx1', xg.lx(1))
h5save(fn, '/lx2', xg.lx(2))
h5save(fn, '/lx3', xg.lx(3))
