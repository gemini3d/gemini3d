...
%glatsrc=38.429575d0     %tohoku
%glonsrc=142.734757d0
%glatsrc=-31.57;    %chile2015
%glonsrc=360-71.654;
...
%dtout=60;
%times=UTsec0:dtout:UTsec0+1800;
%dtout=10;
%times=UTsec0:dtout:UTsec0+3600;
%dtout=10;
%times=UTsec0:dtout:UTsec0+7200;
...
%%COMPUTE AND STORE GRID DISTANCES NEEDED TO DO BIOT-SAVART INTEGRAL
%Rx=zeros(lxp,lyp,lzp,lx);
%Ry=zeros(lxp,lyp,lzp,ly);
%Rz=zeros(lxp,lyp,lzp,lz);
%Rcubed=zeros(lxp,lyp,lzp,lx,ly,lz);    %too much memory; won't work
