...
x2plot=X(:)*Re*sin(meantheta);     %eastward distance - needs to be fixed to be theta-dependent (e.g. sin theta)
...
x3plot=Y2(:)*Re;     %northward distance; NO southward dist. accordinate to setup above!!!
