function h=plotslice3D_curv(t,dmy,xg,parm,parmlbl,caxlims)
...
%size(parmtmp)
%size(inds2),size(inds3),size(inds1)
x3interp=xg.x3(inds3);
x3interp=x3interp(:);
%parmp=interp3(xg.x2(inds2),xg.x3(inds3),xg.x1(inds1),parmtmp,pplot,phiplot,qplot);
