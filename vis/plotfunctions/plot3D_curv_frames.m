function h=plot3D_curv_frames(ymd,UTsec,xg,parm,parmlbl,caxlims,sourceloc)
...
if (~isempty(sourcemlat))
  hold on;
  plot([sourcemlon,sourcemlon],[minxp,maxxp],'w--','LineWidth',2);
  plot(sourcemlon,sourcemlat,'r^','MarkerSize',12,'LineWidth',2);
  hold off;
end
