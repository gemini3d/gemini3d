...
extern void gemini_alloc_C(void**,void**);
...
extern void init_neutralBG_C(void**, int*, void**, int*, double*, double*, double*, void**);
...
extern void init_Efieldinput_C(void**, int*, void**,  double*, void**, int*, double*);
extern void pot2perpfield_C(int*, void**, double**);
extern void BGfield_Lagrangian_C(void**, int*, void**, double**, void**, double*, double*);
extern void init_precipinput_C(void**, int*, void**, double*, int*, double*, void**);
...
extern void neutral_atmos_wind_update_C(void**, double*, double*);
extern void neutral_perturb_C(void**, void**, int*, void**, double*, double*, int*, double*, double*, double*);
