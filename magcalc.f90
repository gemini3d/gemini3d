...
real(8), dimension(:,:), allocatable :: Jxend,Jyend,Jzend,Rxend,Ryend,Rzend,Rcubedend,dVend
real(8), dimension(:,:), allocatable :: integrandend
real(8), dimension(:,:), allocatable :: integrandavgend
