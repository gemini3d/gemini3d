...
if (L LESS 5)  # 3.x or 3.xx
  ...
  elseif(version MATCHES "^3.20")
    set(version "3.20.6")
  elseif(version MATCHES "^3.19")
    set(version "3.19.8")
  elseif(version MATCHES "^3.18")
    set(version "3.18.6")
  elseif(version MATCHES "^3.17")
    set(version "3.17.5")
  elseif(version MATCHES "^3.16")
    set(version "3.16.9")
  elseif(version MATCHES "^3.15")
    set(version "3.15.7")
  elseif(version MATCHES "^3.14")
    set(version "3.14.7")
  elseif(version MATCHES "^3.13")
    set(version "3.13.5")
  endif()
endif()
