...
Vminx1it=zeros(llon,llat,ltout);
Vmaxx1it=zeros(llon,llat,ltout);
Vminx2it=zeros(llat,ltout);
Vmaxx2it=zeros(llat,ltout);
Vminx3it=zeros(llon,ltout);
Vmaxx3it=zeros(llon,ltout);
