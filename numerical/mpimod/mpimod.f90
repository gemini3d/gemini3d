...
use phys_consts, only : wp, lsp   !code needs to know how many species are being used.
use mpi, only: mpi_init, mpi_comm_world, mpi_integer, mpi_double_precision, mpi_status_size, mpi_status_ignore

implicit none

private :: lsp
!private :: mpi_init, mpi_comm_world, mpi_integer, mpi_double_precision, mpi_status_size, mpi_status_ignore
