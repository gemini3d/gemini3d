...
module procedure gather_send32_2D_23
...
call mpi_send(paramtrim, lx2*lx3, mpi_real, 0, tag, MPI_COMM_WORLD, ierr)

end procedure gather_send32_2D_23



module procedure gather_send32_3D_23
...
call mpi_send(paramtrim,lx1*lx2*lx3,mpi_real,0,tag,MPI_COMM_WORLD,ierr)

end procedure gather_send32_3D_23



module procedure gather_send32_4D_23
...
do isp=1,lsp
  ...
  call mpi_send(paramtmp,(lx1+4)*lx2*lx3,mpi_real,0,tag,MPI_COMM_WORLD,ierr)
end do

end procedure gather_send32_4D_23



module procedure bcast_send32_1D_23_2
...
!  islfin=islstart+lx-1
  ...
  call mpi_send(paramall(islstart-2:islfin+2),(lx+4), &
               mpi_real,iid,tag,MPI_COMM_WORLD,ierr)
end do
param=paramall(-1:lx+2)

end procedure bcast_send32_1D_23_2



module procedure bcast_send32_1D_23_3
...
end procedure bcast_send32_1D_23_3


!subroutine bcast_send2D_23(paramtrimall,tag,paramtrim)
module procedure bcast_send32_2D_23
!! -----------------------------------------------------
...
end procedure bcast_send32_2D_23


!subroutine bcast_send3D_23(paramtrimall,tag,paramtrim)
module procedure bcast_send32_3D_23
!! -----------------------------------------------------
!! THIS SUBROUTINE BROADCASTS DATA FROM A FULL GRID ARRAY
!! ON ROOT PROCESS TO ALL WORKERS' SUB-GRID ARRAYS.
!!
...
end procedure bcast_send32_3D_23


!subroutine bcast_send3D_x3i_23(paramtrimall,tag,paramtrim)
module procedure bcast_send32_3D_x3i_23
!! -----------------------------------------------------
!! THIS SUBROUTINE BROADCASTS DATA FROM A FULL GRID ARRAY
!! ON ROOT PROCESS TO ALL WORKERS' SUB-GRID ARRAYS.
!!
...
integer :: iid,islstart,islfin
integer, dimension(4) :: inds
real(real32), dimension(1:size(paramtrim,1),1:size(paramtrim,2),1:size(paramtrim,3)) :: paramtmp    !has size lx3+1 due to input having that size
...
do iid=1,lid-1
  ...
  call mpi_send(paramtmp,lx1*lx2*(lx3+1), &
               mpi_real,iid,tag,MPI_COMM_WORLD,ierr)         !note the +1 since thes are interface quantities (and need to overlap b/t workers)
end do
...
end procedure bcast_send32_3D_x3i_23


!subroutine bcast_send3D_x2i_23(paramtrimall,tag,paramtrim)
module procedure bcast_send32_3D_x2i_23
!! -----------------------------------------------------
!! THIS SUBROUTINE BROADCASTS DATA FROM A FULL GRID ARRAY
!! ON ROOT PROCESS TO ALL WORKERS' SUB-GRID ARRAYS.
!!
...
end procedure bcast_send32_3D_x2i_23


!subroutine bcast_send3D_ghost_23(paramall,tag,param)
module procedure bcast_send32_3D_ghost_23
!! THIS SUBROUTINE BROADCASTS DATA FROM A FULL GRID ARRAY
!!ON ROOT PROCESS TO ALL WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY ROOT TO DO A BROADCAST
...
integer :: iid,islstart,islfin
integer, dimension(4) :: inds
real(real32), dimension(-1:size(param,1)-2,-1:size(param,2)-2,-1:size(param,3)-2) :: paramtmp
...
end procedure bcast_send32_3D_ghost_23



module procedure bcast_send32_4D_23
...
end procedure bcast_send32_4D_23


end submodule mpisend32
