...
module procedure gather_recv64_2D_23
...
end procedure gather_recv64_2D_23


module procedure gather_recv64_3D_23
...
integer :: iid
integer, dimension(4) :: inds
real(real64), dimension(1:size(paramtrim,1),1:size(paramtrim,2),1:size(paramtrim,3)) :: paramtmp   !buffer space for mpi receive, includes only x1 ghost cells
...
do iid=1,lid-1        !must loop over all processes in the grid, don't enter loop if only root is present
  call mpi_recv(paramtmp,lx1*lx2*lx3, &          !note no ghost cells!!!
                mpi_double_precision,iid,tag,MPI_COMM_WORLD,MPI_STATUS_IGNORE,ierr)    !recieve chunk of data into buffer
  inds=slabinds(iid,lx2,lx3)
  paramtrimall(1:lx1,inds(1):inds(2),inds(3):inds(4))=paramtmp    !note the exclusion of the ghost cells
end do

end procedure gather_recv64_3D_23


module procedure gather_recv64_4D_23
...
integer :: iid
integer, dimension(4) :: inds
real(real64), dimension(-1:size(param,1)-2,1:size(param,2)-4,1:size(param,3)-4) :: paramtmp   !buffer space for mpi receive, includes only x1 ghost cells
...
end procedure gather_recv64_4D_23


module procedure bcast_recv64_1D_old3
...
end procedure bcast_recv64_1D_old3


module procedure bcast_recv64_1D_23_2
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_1D_23_2


module procedure bcast_recv64_1D_23_3
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_1D_23_3


module procedure bcast_recv64_2D_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_2D_23


module procedure bcast_recv64_3D_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_3D_23


module procedure bcast_recv64_3D_x3i_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_3D_x3i_23


module procedure bcast_recv64_3D_x2i_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_3D_x2i_23


module procedure bcast_recv64_3D_ghost_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!!
!! SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_3D_ghost_23



module procedure bcast_recv64_4D_23
!! THIS SUBROUTINE RECEIVES BROADCAST DATA FROM A FULL
!! GRID ARRAY ON ROOT PROCESS TO WORKERS' SUB-GRID ARRAYS.
!-------
!-------SUBROUTINE IS TO BE CALLED BY WORKERS TO DO A BROADCAST
...
end procedure bcast_recv64_4D_23



end submodule mpirecv64
